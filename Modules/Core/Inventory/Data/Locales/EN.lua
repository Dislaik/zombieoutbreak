Translations = {
    ...
    ["Player_Give_Encumbered"] = "~y~[Warning]~s~ You tried to give an ~y~%s~s~ to ~b~%s~s~, but he can't carry more things.",
    ...
    ["Player_Give_CantTakeMore"] = "~y~[Warning]~s~ You tried to gave an ~y~%s~s~ to ~b~%s~s~, but he can't take more.",
    ...
    ["Player_Give_HasWeapon"] = "~y~[Info]~s~ You to tried gave an ~y~%s~s~ to ~b~%s~s~, but he already has one.",
